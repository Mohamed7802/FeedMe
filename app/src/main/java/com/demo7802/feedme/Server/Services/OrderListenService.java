package com.demo7802.feedme.Server.Services;
...
public class OrderListenService extends Service {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        databaseReference.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(@NonNull DataSnapshot dataSnapshot, @Nullable String s) {
                com.demo7802.feedme.Request request = dataSnapshot.getValue(com.demo7802.feedme.Request.class);
                assert request != null;
    ...
    //Helper method
    private void showNotification(String key, com.demo7802.feedme.Request request) {
        Intent intent = new Intent(getBaseContext(), com.demo7802.feedme.OrderStatusActivityServer.class);
